...
# Mapping gaya belajar ke link
def get_learning_style_link(processing, perception, input_, understanding):
    learning_style = f"{processing}, {perception}, {input_}, {understanding}"
    links = {
        "active, sensing, visual, sequential": "https://cx.apps.binus.ac.id/enrol/index.php?id=2084",
        "active, sensing, visual, global": "https://cx.apps.binus.ac.id/enrol/index.php?id=2085",
        "active, sensing, verbal, sequential": "https://cx.apps.binus.ac.id/enrol/index.php?id=2086",
        "active, sensing, verbal, global": "https://cx.apps.binus.ac.id/enrol/index.php?id=2087",
        "active, intuitive, visual, sequential": "https://cx.apps.binus.ac.id/enrol/index.php?id=2088",
        "active, intuitive, visual, global": "https://cx.apps.binus.ac.id/enrol/index.php?id=2089",
        "active, intuitive, verbal, sequential": "https://cx.apps.binus.ac.id/enrol/index.php?id=2090",
        "active, intuitive, verbal, global": "https://cx.apps.binus.ac.id/enrol/index.php?id=2091",
        "reflective, sensing, visual, sequential": "https://cx.apps.binus.ac.id/enrol/index.php?id=2092",
        "reflective, sensing, visual, global": "https://cx.apps.binus.ac.id/enrol/index.php?id=2093",
        "reflective, sensing, verbal, sequential": "https://cx.apps.binus.ac.id/enrol/index.php?id=2094",
        "reflective, sensing, verbal, global": "https://cx.apps.binus.ac.id/enrol/index.php?id=2095",
        "reflective, intuitive, visual, sequential": "https://cx.apps.binus.ac.id/enrol/index.php?id=2096",
        "reflective, intuitive, visual, global": "https://cx.apps.binus.ac.id/enrol/index.php?id=2097",
        "reflective, intuitive, verbal, sequential": "https://cx.apps.binus.ac.id/enrol/index.php?id=2098",
        "reflective, intuitive, verbal, global": "https://cx.apps.binus.ac.id/enrol/index.php?id=2099",
    }
    return links.get(learning_style, None)

# App title
st.title("Menentukan Gaya Belajar")
...
if '@binus.ac.id' in email and name:
    ...
    with st.form("prediction_form"):
        ...
        for i, question in enumerate(questions):
            answer = st.radio(question, options=answers[i], index=None)  # Set index to None to make it initially empty
            if answer == answers[i][0]:
                input_value = 1
            elif answer == answers[i][1]:
                input_value = -1
            else:
                input_value = 0  # Handle cases where no option is selected yet (if needed)
                all_answered = False
    ...
    # Jika form telah disubmit dan tidak ada yang kosong
    if submitted:
        if all_answered:
            ...
            # Mendapatkan link berdasarkan hasil prediksi
            link = get_learning_style_link(processing_pred, perception_pred, input_pred, understanding_pred)
            
            if link:
                st.markdown(f"Silakan lanjutkan pembelajaran Anda di [link berikut]({link}).")
            else:
                st.write("Tidak ditemukan link yang sesuai dengan gaya belajar Anda.")
        else:
            st.warning("Harap jawab semua pertanyaan sebelum submit.")
else:
